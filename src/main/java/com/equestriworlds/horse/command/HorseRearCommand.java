...
public class HorseRearCommand
extends CommandBase<HorseManager> {
    public HorseRearCommand(HorseManager plugin) {
        super(plugin, Rank.PLAYER, "rear");
    }
    ...
    public void Execute(Player caller, String[] args) {
        if (args == null || args.length != 1) {
            ...
            UtilPlayer.message((Entity)caller, F.help("/horse rear (ID)", "Call your horse", Rank.PLAYER));
        } else {
            String id = args[0];
